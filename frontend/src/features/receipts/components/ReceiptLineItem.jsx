...
export default function ReceiptLineItem({ line, index, onChange, onRemove }) {
  function handle(e) {
  ...
  return (
    <div className="grid grid-cols-12 gap-3 items-end py-3 border-b border-gray-100 last:border-0">
      ...
      <div className="col-span-3">
        <Input label={index === 0 ? 'Expected Qty' : ''} type="number" name="expectedQty" value={line.expectedQty} onChange={handle} min={1} required />
      </div>
      <div className="col-span-3">
