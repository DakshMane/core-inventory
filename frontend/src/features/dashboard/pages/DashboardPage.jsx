...
export default function DashboardPage() {
  ...
  return (
    <div className="flex gap-6 max-w-5xl">
      ...
      {/* RECEIPT CARD */}
      <div className="flex-1 bg-white border border-gray-200 rounded-2xl p-6 min-h-[220px] flex flex-col justify-between shadow-sm relative overflow-hidden group">
        ...
        <div className="flex justify-between items-end ml-2">
          ...
          <div className="text-gray-500 text-sm space-y-1.5 text-right font-medium">
            <p className="flex justify-between gap-4"><span className="text-gray-400">Late</span> <span className="text-red-500 font-semibold">1</span></p>
            <p className="flex justify-between gap-4"><span className="text-gray-400">Total Ops</span> <span className="text-gray-700">6</span></p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 bg-white border border-gray-200 rounded-2xl p-6 min-h-[220px] flex flex-col justify-between shadow-sm relative overflow-hidden group">
        ...
        <div className="flex justify-between items-end ml-2">
          ...
          <div className="text-gray-500 text-sm space-y-1.5 text-right font-medium">
            <p className="flex justify-between gap-4"><span className="text-gray-400">Late</span> <span className="text-red-500 font-semibold">1</span></p>
            <p className="flex justify-between gap-4"><span className="text-gray-400">Waiting</span> <span className="text-orange-500 font-semibold">2</span></p>
            <p className="flex justify-between gap-4"><span className="text-gray-400">Total Ops</span> <span className="text-gray-700">6</span></p>
          </div>
        </div>
      </div>
